...
abstract contract PrimitiveBase is Initializable, OwnableUpgradeable {
    ...
    constructor(
        ...
        address primitiveStorageContract
    ) {
        ...
        IRobotStorage(primitiveStorageContract).publishPrimitive(
    ...
    function _robotContractBaseInit(
        address owner_,
        string calldata customRules
        ...
        IRobotStateEmitter.StateChangePayload memory state = getRobotState();
        _robotStateEmitter.emitStateChange(state);
    }
    ...
    function _msgSender() internal view virtual override returns (address) {
        ...
        return
            executor == msg.sender
                ? IExecutor(executor).getMsgSigner()
                : msg.sender;
    }
     ...
     */
    function _getRobotStateEmitter()
        internal
        view
        returns (IRobotStateEmitter)
    {
