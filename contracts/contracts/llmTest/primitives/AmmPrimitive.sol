...
contract AmmPrimitive is Initializable, PrimitiveBase {
  ...
  function setFee(uint256 newFee) external onlyOwner {
    ...
    payload.floats[0] = IRobotStateEmitter.NamedFloat("fee", contractFeeFormatToUserFeeFormat(_fee));
  ...
  function activate() external onlyOwner onlyWhenInactive {
    ...
    IRobotStateEmitter.StateChangePayload memory payload = IRobotStateEmitter.StateChangePayload({
      ...
      strings: new IRobotStateEmitter.NamedString[](0),
      addresses: new IRobotStateEmitter.NamedAddress[](0),
      bools: new IRobotStateEmitter.NamedBool[](1)
    });
  ...
  function setTokens(address token1Addr, address token2Addr) public onlyOwner onlyWhenInactive {
    ...
    IRobotStateEmitter.StateChangePayload memory payload = IRobotStateEmitter.StateChangePayload({
      uints: new IRobotStateEmitter.NamedUint[](0),
      floats: new IRobotStateEmitter.NamedFloat[](0),
      strings: new IRobotStateEmitter.NamedString[](2),
      addresses: new IRobotStateEmitter.NamedAddress[](2),
      bools: new IRobotStateEmitter.NamedBool[](0)
    });
  ...
  function removeLiquidity(uint256 amount) external {
    ...
    IRobotStateEmitter.NamedFloat[] memory floats = new IRobotStateEmitter.NamedFloat[](3);
    floats[0] = IRobotStateEmitter.NamedFloat(
      "totalLiquidityShares",
      _tokenOnePrimitive.contractFormatToUserFormat(totalLiquidityShares)
    );
    floats[1] = IRobotStateEmitter.NamedFloat(
      "token1Liquidity",
      _tokenOnePrimitive.contractFormatToUserFormat(_reserves1)
    );
    floats[2] = IRobotStateEmitter.NamedFloat(
      "token2Liquidity",
      _tokenTwoPrimitive.contractFormatToUserFormat(_reserves2)
    );

    IRobotStateEmitter.NamedUint[] memory uints = new IRobotStateEmitter.NamedUint[](holderChanged ? 1 : 0);
    if (holderChanged) {
      uints[0] = IRobotStateEmitter.NamedUint("totalLiquidityHolders", _liquidityHolderCount);
    }

    IRobotStateEmitter.NamedString[] memory emptyStrings = new IRobotStateEmitter.NamedString[](0);
    IRobotStateEmitter.NamedAddress[] memory emptyAddresses = new IRobotStateEmitter.NamedAddress[](0);
    IRobotStateEmitter.NamedBool[] memory emptyBools = new IRobotStateEmitter.NamedBool[](0);
  ...
  function swap(address token, uint256 amountIn) external onlyWhenActive {
    ...
    IRobotStateEmitter.StateChangePayload memory payload = IRobotStateEmitter.StateChangePayload({
      uints: new IRobotStateEmitter.NamedUint[](1),
      floats: new IRobotStateEmitter.NamedFloat[](3),
      strings: new IRobotStateEmitter.NamedString[](0),
      addresses: new IRobotStateEmitter.NamedAddress[](0),
      bools: new IRobotStateEmitter.NamedBool[](0)
  ...
  function contractFeeFormatToUserFeeFormat(uint256 userInteger) public pure returns (string memory) {
  ...
  //             floats: new IRobotStateEmitter.NamedFloat[](6),
  //             strings: new IRobotStateEmitter.NamedString[](2),
  //             addresses: new IRobotStateEmitter.NamedAddress[](2),
  //             bools: new IRobotStateEmitter.NamedBool[](1)
  //         });
  ...
  //         "fee",
  //         contractFeeFormatToUserFeeFormat(_fee)
  //     );
